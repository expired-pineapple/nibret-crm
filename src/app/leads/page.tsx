...
interface Leads {
  ...
  lead_name: number | string;
  interested_in: number | string;
  calls: number | string;
  ...
  return (
    <div className="p-4 sm:ml-64">
      <div className="p-4  dark:border-gray-700 mt-14">
        <h2 className="mb-4 text-3xl text-gray-500 dark:text-gray-400">
          Leads
        </h2>
                ...
                {leads.map((lead) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <td className="px-6 py-3">{lead.interested_in}</td>
                      <td className="px-6 py-3">{lead.calls}</td>
                      <td className="px-6 py-3">{lead.status}</td>
                      <td className="px-6 py-3">{lead.emails}</td>
                      <td className="px-6 py-3">{lead.texts}</td>
                    </tr>
                  </Link>
                ))}
              </tbody>
